...
export const wordsList = {
  ...
  All: { color: '#20E3B2' },
  parse: { color: '#20E3B2' },
  toUpperCase: { color: '#20E3B2' },
  toString: { color: '#20E3B2' },
  stringify: { color: '#20E3B2' },
  addEventListener: { color: '#20E3B2' },
  removeEventListener: { color: '#20E3B2' },
  add: { color: '#20E3B2' },
  remove: { color: '#20E3B2' },
  toggle: { color: '#20E3B2' },
  ...
  keys: { color: '#20E3B2' },
  join: { color: '#20E3B2' },
  replaceChildren: { color: '#20E3B2' },
  replaceChild: { color: '#20E3B2' },
  replaceWith: { color: '#20E3B2' },
